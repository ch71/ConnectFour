package wut.cholo71796.register.payment;
...
public class Methods {
     ...
     */
    private void _init() {
        this.addMethod("iConomy", new wut.cholo71796.register.payment.methods.iCo6());
        this.addMethod("iConomy", new wut.cholo71796.register.payment.methods.iCo5());
        this.addMethod("iConomy", new wut.cholo71796.register.payment.methods.iCo4());
        this.addMethod("BOSEconomy", new wut.cholo71796.register.payment.methods.BOSE6());
        this.addMethod("BOSEconomy", new wut.cholo71796.register.payment.methods.BOSE7());
        this.addMethod("Essentials", new wut.cholo71796.register.payment.methods.EE17());
        this.addMethod("MultiCurrency", new wut.cholo71796.register.payment.methods.MCUR());
    }
